...
public class FirebaseDBHelper {
    ...
    public static void uploadAllData() {
        ...
        db.child(rootPath + "4_Physical Performance" + "/" + "2_Speed").setValue(MainActivity.trainingData.getAvgSpeed());
        db.child(rootPath + "4_Physical Performance" + "/" + "3_Pace").setValue(MainActivity.trainingData.getAvgPace());
        db.child(rootPath + "4_Physical Performance" + "/" + "4_Speed list").setValue(MainActivity.trainingData.getAvgPace());
